...
privileged aspect Demandante_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Demandante.fieldNames4OrderClauseFilter = java.util.Arrays.asList("nombre", "apellidos", "sexo", "email", "telefono", "inscripciones", "curriculum", "fechaNacimiento");
