...
privileged aspect UsuarioController_Roo_GvNIXLoupeController {
    
    @Autowired
    public ConversionService UsuarioController.conversionService_loupe;
    
    @Autowired
    public EntityManagerProvider UsuarioController.entityManagerProvider_loupe;
    
    @RequestMapping(params = "selector", produces = "text/html")
    public String UsuarioController.showOnlyList(Model uiModel, HttpServletRequest request, @RequestParam("path") String listPath) {
        ...
        if (StringUtils.isNotBlank(parentId)) {
            ...
            uiModel.addAttribute("parentId", "Usuario_selector");
        }
    ...
    public ResponseEntity<List<Map<String, String>>> UsuarioController.findUsingAjax(WebRequest request, @RequestParam(value = "_search_", required = false) String search, @RequestParam(value = "_id_", required = false) String id, @RequestParam("_pkField_") String pkField, @RequestParam(value = "_max_", required = false, defaultValue = "3") Integer maxResult, @RequestParam(value = "_caption_", required = false) String caption, @RequestParam(value = "_additionalFields_", required = false) String additionalFields, @RequestParam("_field_") String field) {
        ...
        // Getting Entity
        BeanWrapper usuarioBean = new BeanWrapperImpl(Usuario.class);
        // Getting field
        Class targetEntity = usuarioBean.getPropertyType(field);
